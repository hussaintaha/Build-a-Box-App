...
class Auth extends CI_Controller{
    ...
    public function auth($shop) {
      ...
      // $scopes = array('read_content','read_draft_orders','write_draft_orders','write_content', 'read_themes', 'write_themes', 'read_products', 'write_products', 'read_script_tags', 'write_script_tags', 'read_price_rules', 'read_product_listings', 'read_collection_listings','read_inventory', 'write_inventory','read_locations');

       $scopes = array('read_content', 'write_content', 'read_themes', 'write_themes', 'read_products', 'write_products', 'read_script_tags', 'write_script_tags', 'read_price_rules', 'read_product_listings', 'read_collection_listings', 'read_inventory', 'write_inventory', 'read_locations','read_orders', 'write_orders','write_draft_orders', 'read_draft_orders');
