...
<div class="Polaris-Layout__AnnotatedSection">
   <div class="Polaris-Layout__AnnotationWrapper">
      ...
      <div class="Polaris-Layout__AnnotationContent">
        ...
        <input type="hidden" value="<?=$bx_data->id?>" name="bx_id">
                        ...
                        <div class="Polaris-Connected">
                           <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                              <div class="Polaris-TextField Polaris-TextField--hasValue">
                                 <input id="PolarisTextField1" value="<?=$bx_data->bx_title?>" class="Polaris-TextField__Input txt-input"  type="text" name="bx_title"     >
                        ...
                        <div style="width:40%;">
                           <fieldset class="Polaris-ChoiceList" id="PolarisChoiceList14" aria-invalid="false">
                                  ...
                                  <label class="Polaris-Choice" for="PolarisRadioButton35">
                                      <span class="Polaris-Choice__Control">
                                          <span class="Polaris-RadioButton">
                                              ...
                                              <?=(($bx_data->bx_include_price) == 'yes' ? "checked" : "")?>
                                ...
                                <label class="Polaris-Choice" for="PolarisRadioButton36">
                                    <span class="Polaris-Choice__Control">
                                        <span class="Polaris-RadioButton">
                                            <input id="PolarisRadioButton36"
                                             name="inc_box_price" type="radio"  class="Polaris-RadioButton__Input box_price" value="no"    >
                                            <span class="Polaris-RadioButton__Backdrop"></span>
                                            <span class="Polaris-RadioButton__Icon"></span>
                                        </span>
                                    </span>
   ...
   <div class="Polaris-Layout__AnnotationWrapper">
      ...
      <div class="Polaris-Layout__AnnotationContent">
         ...
         <div class="Polaris-Card">
            <div class="Polaris-Card__Section">
               <div class="Polaris-FormLayout">
                 <div class="UPDLoader" style="display:none;">
                       ...
                       <div class="">
                          ...
                          <img width="100" class="thumb" height="100" src="<?=base_url('assets/images/no-image.png') ?>" alt="">
                            <span class="afterUpload">
                                    ...
                                    <img width="100" id="loadImage" class="thumb" height="100" src="<?=$bx_data->bx_before_image?>" >
                            </span>
                       </div>
                     <div class="">
                        <div class="Polaris-Labelled__LabelWrapper">
                  ...
                  <div class="Polaris-FormLayout__Item">
                     <div class="">
                        ...
                        <span class="afterUpload" >
                            <img width="100" height="100" src="<?=base_url('assets/images/double-arrow.png') ?>" alt="">
                            <img width="100" id="loadImage" class="thumb" height="100" src="<?=$bx_data->bx_after_image?>" alt="">
                        </span>
                     </div>
                     <div class="">
                        <div class="Polaris-Labelled__LabelWrapper">
                     ...
                     <input type="hidden" value="<?=$bx_data->bx_after_image?>" name="after_image" class="after_image bxImages">
                     <input type="hidden"  value="<?=$bx_data->bx_before_image?>" name="before_image" class="before_image bxImages">
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="Polaris-Layout__AnnotationWrapper">
      <div class="Polaris-Layout__Annotation">
         <div class="Polaris-TextContainer">
            ...
            <div class="Polaris-Layout__AnnotationDescription">
               <p>Limit Contents added In the Cart</p>
            </div>
         </div>
      </div>
      <div class="Polaris-Layout__AnnotationContent">
            ...
            <div class="Polaris-Card__Section">
               <div class="Polaris-FormLayout">
                     ...
                     <div class="">
                        ...
                        <label class="Polaris-Choice" for="PolarisCheckbox2">
                            <span class="Polaris-Choice__Control">
                              ...
                              <input id="PolarisCheckbox2" type="checkbox"
                              <?=(($bx_data->bx_contents_based_on_product == 1) ? "checked" : "" ) ?>
                               name="productCount" data-show="MaxProduct" class="Polaris-Checkbox__Input chkbxs">
                        ...
                        <label class="Polaris-Choice" for="PolarisCheckbox3">
                            <span class="Polaris-Choice__Control">
                              ...
                              <input id="PolarisCheckbox3" data-show="MaxPrice" type="checkbox"
                                ...
                                <?=(($bx_data->bx_contents_based_on_bx_amt == 1) ? "checked" : "" ) ?>                       >
                              <span class="Polaris-Checkbox__Backdrop"></span>
                                <span class="Polaris-Checkbox__Icon">
                                    <span class="Polaris-Icon">
                                      <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                  ...
                  <div class="Polaris-FormLayout__Item"
                   ...
                   <?=(($bx_data->bx_contents_based_on_product == 0) ? "style='display:none;'" : "" ) ?>
                    id="MaxProduct">
                     <div class="">
                        <div class="Polaris-Labelled__LabelWrapper">
                           <div class="Polaris-Label">
                        ...
                        <div class="Polaris-Connected">
                           <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                              <div class="Polaris-TextField">
                                 ...
                                 value="<?=$bx_data->bx_max_no_products?>"
                  ...
                  <div class="Polaris-FormLayout__Item"
                   <?=(($bx_data->bx_contents_based_on_bx_amt == 0) ? "style='display:none;'" : "" ) ?>
                     id="MaxPrice">
                     <div class="">
                        <div class="Polaris-Labelled__LabelWrapper">
                           <div class="Polaris-Label">
         ...
         <div class="Polaris-Card">
            <div class="Polaris-Card__Section">
               <div class="Polaris-FormLayout">
                     ...
                     <div class="">
                        ...
                        <label class="Polaris-Choice" for="PolarisRadioButton41">
                            <span class="Polaris-Choice__Control">
                              ...
                              <?php if ($bx_data->gift_selection_basis == 'collection') { echo "checked"; } ?>
                              >
                              <span class="Polaris-RadioButton__Backdrop"></span>
                        ...
                        <label class="Polaris-Choice" for="PolarisRadioButton42">
                            <span class="Polaris-Choice__Control">
                              ...
                              class="Polaris-RadioButton__Input rdbtns"
                              value="product"
                              <?php if ($bx_data->gift_selection_basis == 'product') { echo "checked"; } ?>
                              >
                              <span class="Polaris-RadioButton__Backdrop"></span>
                                <span class="Polaris-RadioButton__Icon">
                                    <span class="Polaris-Icon">
                        ...
                        <label class="Polaris-Choice" for="PolarisRadioButton43">
                            <span class="Polaris-Choice__Control">
                              ...
                              <input id="PolarisRadioButton43"
                               ...
                               value="tag"
                               class="Polaris-RadioButton__Input rdbtns"
                               <?php if ($bx_data->gift_selection_basis == 'tag') { echo "checked"; } ?>
                               >
                              <span class="Polaris-RadioButton__Backdrop"></span>
                                <span class="Polaris-RadioButton__Icon">
                                    <span class="Polaris-Icon">
                  ...
                  <div id="SelectTags" class="Polaris-FormLayout__Item productSelectors" style="<?php if ($bx_data->gift_selection_basis != 'tag') { echo "display:none;"; } ?>">
                     <div class="">
                        <div class="Polaris-Labelled__LabelWrapper">
                           <div class="Polaris-Label">
                        ...
                        <div class="Polaris-Connected">
                           <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                              <div class="Polaris-TextField">
                                 <input  class="Polaris-TextField__Input tag_input txt-input" type="text">
                                 <div class="Polaris-TextField__Backdrop"></div>
                              </div>
                           </div>
                        </div>
                        <div class="tagsselected" style="margin-top: 3%;">
                          <?php if (($bx_data->gift_selection_basis == 'tag') && ($bx_data->select_tags != null)): ?>
                            <?php $select_tags = $bx_data->select_tags; ?>
                            <?php $tags = explode(",",$select_tags); ?>
                            <?php foreach ($tags as $tag): ?>
                            <span class="Polaris-Tag" style="margin-right: 2%;">
                              <input type="hidden" name="tags[]" value="<?=$tag?>">
                              <span title="<?=$tag?>" class="Polaris-Tag__TagText"><?=$tag?></span>&nbsp;&nbsp;<span style="cursor:pointer" class="remove_tag">&#215;</span>
                            </span>
                            <?php endforeach; ?>
                          <?php endif; ?>
                        </div>
                  ...
                  <div id="SelectCollection" class="Polaris-FormLayout__Item productSelectors" style="<?php if ($bx_data->gift_selection_basis != 'collection') { echo "display:none;"; } ?>">
                     <div class="">
                        <div class="Polaris-Connected">
                             <div class="Polaris-DataTable">
                                <div class="Polaris-DataTable__ScrollContainer">
                                   <table class="Polaris-DataTable__Table">
                                      ...
                                      <tbody>
                                        <?php if ($bx_data->gift_selection_basis == 'collection'): ?>
                                          <?php $collection = json_decode($bx_data->collection_data); ?>
                                          <tr class="Polaris-DataTable__TableRow" id="cls<?=$collection->id?>">
                                            <input type="hidden" name="collection_handle" value="<?=$collection->handle?>">
                                            <input type="hidden" name="collection_data" value='<?=$bx_data->collection_data?>'>
                                            <th class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn" scope="row">
                                              <?php if ($collection->image == null): ?>
                                                <svg style="height:50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                                  <path fill="#637381" d="M19 0H1a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1zM8 6c.551 0 1 .449 1 1 0 .551-.449 1-1 1-.551 0-1-.449-1-1 0-.551.449-1 1-1m0 4c1.654 0 3-1.346 3-3S9.654 4 8 4 5 5.346 5 7s1.346 3 3 3m-6 8v-2.434l3.972-2.383 2.473 1.649a1 1 0 0 0 1.262-.125l4.367-4.367L18 13.48V18H2zM18 2v8.919l-3.375-2.7a1 1 0 0 0-1.332.074l-4.42 4.42-2.318-1.545a1 1 0 0 0-1.07-.025L2 13.234V2h16z"/>
                                                </svg>
                                              <?php else: ?>
                                                <a href="<?php if (isset($collection->image->src)) {echo$collection->image->src;} ?>" target="_blank">
                                                  <span class="Polaris-Thumbnail Polaris-Thumbnail--sizeMedium">
                                                    <img src="<?php if (isset($collection->image->src)) {echo $collection->image->src;} ?>"
                                                    alt="<?php if (isset($collection->image->alt)) {echo $collection->image->alt;} ?>" class="Polaris-Thumbnail__Image">
                                                  </span>
                                                </a>
                                              <?php endif; ?>
                                            </th>
                                            <td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">
                                              <a target="_blank" href="https://<?=$shop?>/admin/collections/<?=$collection->id?>"><?=$collection->title?></a>
                                            </td>
                                            <td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">
                                              <span style="cursor:pointer" class="removeCollection">&#215;</span>
                                            </td>
                                          </tr>
                                        <?php endif; ?>
                                      </tbody>
                  ...
                  <div id="SelectProduct" class="Polaris-FormLayout__Item productSelectors" style="<?php if ($bx_data->gift_selection_basis != 'product') { echo "display:none;"; } ?>">
                     <div class="">
                        <div class="Polaris-Connected">
                            <div class="Polaris-DataTable">
                              <div class="Polaris-DataTable__ScrollContainer">
                                 <table class="Polaris-DataTable__Table">
                                    ...
                                    <tbody>
                                      ...
                                      <?php $box_products = $bx_data->box_products; ?>
                                      <script type="text/javascript">
                                        var productsArray = [];
                                      </script>
                                      <?php foreach ($box_products as $box_product): ?>
                                        <?php $box_product = json_decode($box_product->product_json); ?>

                                        <!--  -->
                                        <?php $bx_prdct = (array) $box_product; ?>
                                        <?php $bx_prdct = json_encode($bx_prdct); ?>
                                        <script type="text/javascript">
                                          var $box_product = <?=$bx_prdct?>;
                                          productsArray.push($box_product);
                                        </script>
                                        <!--  -->

                                          <tr class="Polaris-DataTable__TableRow" id="pr<?=$box_product->id?>">
                                            <th class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn" scope="row">
                                              <input type="hidden" name="bx_gift_products[]" value="<?=$box_product->id?>">
                                              <a href="<?=$box_product->image->src?>" target="_blank">
                                                <span class="Polaris-Thumbnail Polaris-Thumbnail--sizeMedium">
                                                  <img src="<?=$box_product->image->src?>" alt="<?=$box_product->image->alt?>" class="Polaris-Thumbnail__Image">
                                                </span>
                                              </a>
                                            </th>
                                            <td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">
                                              <a target="_blank" href="https://<?=$shop?>/admin/products/<?=$box_product->id?>"><?=$box_product->title?></a>
                                            </td>
                                            <td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric"><?=$box_product->variants[0]->price?></td>
                                            <td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">
                                              <span style="cursor:pointer" class="removeCollection">&#215;</span>
                                            </td>
                                          </tr>
          ...
          <div class="Polaris-Modal__BodyWrapper">
            <div class="Polaris-Modal__Body Polaris-Scrollable Polaris-Scrollable--vertical" data-polaris-scrollable="true">
              <section class="Polaris-Modal-Section">
                <div class="Polaris-TextContainer">
                  <p>Please Wait While Updating Boxes.</p>
...
function OpenProductPicker(){
  ShopifyApp.Modal.productPicker( {selectMultiple: true}, function(success, data) {
    ...
    if (data.products.length > 0) {
      ...
      // Merge ond and new array with unique objects
      var mergedOldNewProducts = [];
      for (var i = 0; i < productsArray.length; i++) {
        var productObj = productsArray[i];
        var resultObjectPosition = search(productObj.id, selectedProducts);
        if (resultObjectPosition >= 0) {
          selectedProducts.splice(resultObjectPosition, 1);
        }
      }
      // End

      mergedOldNewProducts = productsArray.concat(selectedProducts);

      CreateProductsHtml(mergedOldNewProducts);
    }
    if (data.errors) {
      console.error(data.errors);
    }
...
<?php
  foreach (explode(',',$bx_data->bx_colors) as $color) { ?>
    $('.colors').append(ReturnSelectedColor('<?=$color?>'));
  <?php }
?>
